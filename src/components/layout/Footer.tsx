    ...
    <footer className="bg-slate-950 text-slate-200 py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-lg font-bold">Aamir Property Dealer</span>
            </div>
            <p className="text-slate-400 mb-4 max-w-xs">
              Helping you find your dream property for over 15 years. Trusted by thousands of satisfied customers.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#properties" className="text-slate-400 hover:text-white transition-colors">
                  Properties
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-slate-400">123 Property Lane, Luxury Heights, Islamabad, Pakistan</span>
              </li>
        ...
        <div className="border-t border-slate-800 mt-8 pt-8 text-center text-slate-400 text-sm">
          <p>&copy; {currentYear} Aamir Property Dealer. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
