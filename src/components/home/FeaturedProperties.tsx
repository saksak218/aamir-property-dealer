...
const propertyCategories = [
  ...
  { id: "residential", name: "Residential", icon: <Home className="h-4 w-4 mr-2" /> },
  { id: "commercial", name: "Commercial", icon: <Warehouse className="h-4 w-4 mr-2" /> },
...
const properties: PropertyProps[] = [
  ...
  },
  {
    ...
    price: "Rs. 18.5 Cr",
    imageUrl: "https://images.pexels.com/photos/342800/pexels-photo-342800.jpeg",
    bedrooms: 0,
    bathrooms: 4,
    area: "8000 sq ft",
  },
...
const FeaturedProperties = () => {
  ...
  return (
    <section id="properties" className="py-16 md:py-24 bg-slate-50 dark:bg-slate-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Discover our handpicked selection of premium properties that offer exceptional value and luxurious living experiences.
          </p>
        </div>
